...
export interface ReferencialUC {
  ...
  aptidoes?: string[];   // do referencial oficial (opcional)
  atitudes?: string[];   // do referencial oficial (opcional)
}
...
export const REFERENCIAL_811RA144: Record<string, ReferencialUC> = {
  ...
  UC01999: {
    ...
    conhecimentos: [
      ...
      'Organização e funcionamento de uma cozinha.',
      'Vocabulário técnico.',
      ...
      'Técnicas de limpeza e preparação de legumes e vegetais.',
      'Principais cortes de legumes e vegetais.',
      'Técnicas de limpeza e preparação de carnes de açougue, criação e caça.',
      'Principais cortes de carnes de açougue, criação e caça.',
      'Técnicas de limpeza e preparação de peixes, moluscos e crustáceos.',
      'Principais cortes de peixes e moluscos.',
      'Técnicas dos principais métodos de confeção.',
    ...
    aptidoes: [
      'Interpretar normas e instruções.',
      'Utilizar vocabulário técnico.',
      'Distribuir tarefas.',
      'Identificar os géneros alimentícios de origem animal e vegetal.',
      'Reconhecer características de carnes de açougue, criação e caça.',
      'Distinguir famílias de peixes.',
      'Identificar características de peixes e mariscos.',
      'Identificar características de ovos, leite e derivados.',
      'Manusear equipamentos e utensílios em segurança.',
      'Aplicar as normas e procedimentos de manipulação de alimentos.',
      'Aplicar técnicas de corte de legumes, vegetais, carnes, peixes e outros géneros alimentícios.',
      'Limpar e preparar legumes e vegetais.',
      'Limpar e preparar carnes de açougue, criação e caça.',
      'Limpar e preparar peixes, moluscos e crustáceos.',
      'Aplicar técnicas de confeção de acordo com o receituário e os géneros alimentícios.',
      'Aplicar os procedimentos de controlo de qualidade.',
      'Aplicar as normas de acondicionamento, conservação e armazenamento de géneros alimentícios.',
      'Aplicar medidas de redução do desperdício alimentar.',
      'Aplicar as normas de higiene e segurança alimentar.',
      'Aplicar as normas de segurança e saúde no trabalho.',
    ],
    atitudes: [
      ...
      'Respeito pelas normas de higiene e segurança alimentar.',
  ...
  UC02002: {
    ...
    realizacoes: [
      'Elaborar fichas técnicas.',
      'Preparar a mise en place.',
      'Preparar e executar confeções de sopas, cremes, aveludados e consommés.',
      'Preparar e executar confeções de entradas e acepipes.',
      'Preparar e executar confeções de pratos de ovos e massas.',
    ...
    conhecimentos: [
      ...
      'Fichas técnicas — unidades de medida, capitações, desperdícios.',
      'Receituário de confeções de acepipes, entradas líquidas e sólidas quentes e frias, pratos de massa e de ovos.',
      'Técnicas de preparação e confeção de acepipes, entradas líquidas e sólidas quentes e frias.',
      'Técnicas de preparação e confeção de sopas, cremes, aveludados e consommés.',
      'Técnicas de preparação e confeção de pratos de ovos.',
      'Técnicas de preparação e confeção de pratos de massas.',
      'Equipamentos e utensílios necessários e sua tecnologia.',
      'Controlo de qualidade do processo de fabrico — preparação, confeção, produtos finais.',
      'Técnicas de empratamento e decoração de produtos confecionados.',
      'Técnicas de acondicionamento, etiquetagem e conservação de matérias-primas e produtos confecionados.',
      'Receituário de confeções base de pastelaria — massas, recheios, cremes e molhos.',
      'Massas base na pastelaria — tipologia.',
      'Principais recheios e cremes base de pastelaria.',
      'Principais molhos base de pastelaria.',
      'Sustentabilidade e economia circular na restauração.',
      'Desperdício na restauração — alimentar, energético, água, embalagens.',
      'Normas de higiene e segurança alimentar.',
      'Normas de segurança e saúde no trabalho.',
    ],
    aptidoes: [
      'Interpretar e elaborar fichas técnicas.',
      'Aplicar procedimentos de quantificação de ingredientes e capitações.',
      'Efetuar o planeamento da produção de cozinha.',
      'Selecionar os equipamentos, ingredientes e utensílios necessários à confeção de acepipes, entradas, sopas, pratos de massa e de ovos.',
      'Selecionar as matérias-primas e verificar a sua qualidade e frescura.',
      'Aplicar os procedimentos para a preparação e confeção de acepipes, entradas, sopas, pratos de massa e de ovos.',
      'Aplicar os procedimentos para a preparação e confeção de bases de pastelaria (massas, recheios, cremes e molhos).',
      'Aplicar técnicas de empratamento e decoração dos produtos confecionados.',
      'Aplicar técnicas de acondicionamento, etiquetagem e conservação.',
      'Aplicar técnicas de limpeza e desinfeção.',
      'Aplicar medidas de redução do desperdício alimentar.',
      'Aplicar as normas de higiene e segurança alimentar.',
      'Aplicar as normas de segurança e saúde no trabalho.',
  ...
  UC03593: {
    ...
    conhecimentos: [
      'Tecnologia dos equipamentos e utensílios de uma padaria.',
      'Procedimentos de organização e produção de uma padaria.',
      'Técnicas de planeamento da produção de padaria.',
      'Fichas técnicas e sua constituição.',
      ...
      'Tecnologia das matérias-primas da padaria.',
      'Receitas e fichas técnicas de massas de panificação.',
      'Massas lêvedas de padaria — pão de milho, pão de mistura, pão de centeio, outras.',
      'Matérias-primas na confeção de massas lêvedas.',
      'Técnicas de preparação e confeção de massas lêvedas de padaria e respetivas aplicações.',
      'Normas de manipulação de alimentos.',
      'Técnicas de limpeza e desinfeção.',
      'Processo de fabrico de massas de padaria e respetivas aplicações.',
      'Procedimentos de controlo da qualidade.',
      'Especialidades regionais de produtos de pão e respetivas aplicações.',
      'Matérias-primas e processo de fabrico das massas regionais.',
      'Requisitos de qualidade do produto final.',
      'Acondicionamento e conservação dos produtos confecionados e dos utensílios e materiais do serviço.',
      'Procedimentos de gestão de stocks.',
      'Sustentabilidade e economia circular na restauração.',
    ],
    aptidoes: [
      'Interpretar e analisar documentos relativos à organização e funcionamento de uma padaria.',
      'Analisar o plano de produção e outras orientações relativas à produção.',
      'Interpretar fichas técnicas em língua portuguesa e inglesa.',
      'Selecionar e aplicar procedimentos de organização e produção de uma padaria.',
      'Aplicar técnicas de planeamento da produção de padaria.',
      ...
      'Selecionar as matérias-primas para a confeção dos produtos de padaria.',
      'Aplicar normas de manipulação de alimentos.',
      'Aplicar técnicas de limpeza e desinfeção.',
      'Analisar e utilizar processos de fabrico de massas de padaria e respetivas aplicações.',
      'Aplicar procedimentos de controlo de qualidade.',
      'Selecionar e aplicar procedimentos de acondicionamento e conservação dos produtos confecionados.',
      'Aplicar procedimentos de gestão de stocks.',
      'Aplicar medidas de redução do desperdício alimentar.',
      'Aplicar as normas de higiene e segurança alimentar.',
      'Aplicar as normas de segurança e saúde no trabalho.',
    ],
  ...
  UC03595: {
    ...
    conhecimentos: [
      ...
      'Técnicas de planeamento da produção de cozinha.',
      'Plano de produção e orientações relativas à produção — reservas, encomendas, serviços especiais, outras.',
      'Fichas técnicas e sua constituição.',
      'Técnicas de cálculo de capitações.',
      'Nutrição e dietética.',
      'Processos e tempos de confeção.',
      'Procedimentos de quantificação de ingredientes, proporções e pesagens.',
      'Técnicas de cálculo de preços.',
      'Cozinha alternativa — vegetariana, macrobiótica, dietética e biológica.',
      'Matérias-primas utilizadas na cozinha alternativa e sua tecnologia.',
      'Procedimentos de manipulação de alimentos.',
      'Noções de higiene e desinfeção.',
      'Técnicas de preparação e confeção de cozinha alternativa — confeção a vácuo, confeção a baixas temperaturas.',
      'Equipamentos e utensílios necessários e procedimentos de controlo dos processos de preparação e confeção de cozinha alternativa.',
      'Técnicas de empratamento e processos de decoração de cozinha alternativa.',
      'Procedimentos de controlo da qualidade.',
    ...
    aptidoes: [
      ...
      'Selecionar e aplicar as técnicas de preparação de cozinha alternativa.',
      'Organizar o espaço, os equipamentos e os utensílios.',
      'Aplicar os procedimentos para a confeção de cozinha alternativa.',
      'Aplicar as técnicas de empratamento e os processos de decoração de cozinha alternativa.',
      'Aplicar normas de manipulação de alimentos.',
