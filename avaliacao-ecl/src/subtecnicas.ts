...
export const SUBTECNICAS: Competencia[] = [
  ...
  { id: 'S015', categoria: 'TECNICAS', nome: 'Acondicionar, conservar, refrigerar e congelar', uc: ['UC03585','UC03584'], tecnicaMaeId: 'T15', palavrasChave: ['acondicionar','conservar','refrigerar','congelar'] },
  { id: 'S016', categoria: 'TECNICAS', nome: 'Regenerar alimentos', uc: ['UC03585'], tecnicaMaeId: 'T15', palavrasChave: ['regenerar','reaquecer'] },
  { id: 'S017', categoria: 'TECNICAS', nome: 'Abater temperatura', uc: ['UC03585','UC03584'], tecnicaMaeId: 'T15', palavrasChave: ['abater temperatura','abatimento','arrefecer rapidamente'] },
  ...
  // ================================================================
  { id: 'S050', categoria: 'TECNICAS', nome: 'Juliana', uc: ['UC01999'], tecnicaMaeId: 'T03', palavrasChave: ['juliana','tiras finas'] },
  { id: 'S051', categoria: 'TECNICAS', nome: 'Brunoise', uc: ['UC01999'], tecnicaMaeId: 'T03', palavrasChave: ['brunoise','cubos pequenos'] },
  ...
  { id: 'S094', categoria: 'TECNICAS', nome: 'Refogar', uc: ['UC01999'], tecnicaMaeId: 'T06', palavrasChave: ['refogar','refogado','refogar cebola','refogar alho'] },
  { id: 'S095', categoria: 'TECNICAS', nome: 'Saltear', uc: ['UC01999'], tecnicaMaeId: 'T06', palavrasChave: ['saltear','salteado'] },
  ...
  { id: 'S100', categoria: 'TECNICAS', nome: 'Grelhar', uc: ['UC01999','UC02003','UC02004'], tecnicaMaeId: 'T06', palavrasChave: ['grelhar','grelhado','grelha','chapa'] },
  { id: 'S101', categoria: 'TECNICAS', nome: 'Assar', uc: ['UC01999','UC02003','UC02004'], tecnicaMaeId: 'T06', palavrasChave: ['assar','assado','forno'] },
  ...
  // ================================================================
  { id: 'S120', categoria: 'TECNICAS', nome: 'Preparar sopa', uc: ['UC02002'], tecnicaMaeId: 'T07', palavrasChave: ['sopa','caldo verde','canja'] },
  ...
  // ================================================================
  { id: 'S200', categoria: 'TECNICAS', nome: 'Lavar mãos corretamente', uc: ['UC03584'], tecnicaMaeId: 'T20', palavrasChave: ['lavar mãos','lavagem de mãos'] },
  { id: 'S201', categoria: 'TECNICAS', nome: 'Utilizar touca e EPI', uc: ['UC03584'], tecnicaMaeId: 'T20', palavrasChave: ['touca','epi','equipamento proteção'] },
  { id: 'S202', categoria: 'TECNICAS', nome: 'Higienizar bancada, equipamentos e utensílios', uc: ['UC03584'], tecnicaMaeId: 'T20', palavrasChave: ['higienizar bancada','higienizar equipamento','higienizar utensílio','desinfetar bancada'] },
  { id: 'S203', categoria: 'TECNICAS', nome: 'Registar temperaturas', uc: ['UC03584'], tecnicaMaeId: 'T19', palavrasChave: ['registar temperatura','controlo temperatura'] },
  { id: 'S204', categoria: 'TECNICAS', nome: 'Preencher registos HACCP', uc: ['UC03584'], tecnicaMaeId: 'T19', palavrasChave: ['registos haccp','preencher registos'] },
  { id: 'S205', categoria: 'TECNICAS', nome: 'Identificar não conformidades e aplicar medidas corretivas', uc: ['UC03584'], tecnicaMaeId: 'T19', palavrasChave: ['não conformidade','medida corretiva'] },
  { id: 'S206', categoria: 'TECNICAS', nome: 'Controlar contaminação cruzada', uc: ['UC03584'], tecnicaMaeId: 'T19', palavrasChave: ['contaminação cruzada'] },
